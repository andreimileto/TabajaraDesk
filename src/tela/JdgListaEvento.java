 ...
 * @author Mileto
 */
public class JdgListaEvento extends javax.swing.JDialog {

    Event event;

    public JdgListaEvento(java.awt.Frame parent, boolean modal, Event event) {
        super(parent, modal);
        initComponents();
        this.event = event;
        listarCidades();
    ...
    public JdgListaEvento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        listarCidades();
        //Validacao.setaPermissoes(this.getClass().getName(),this.jPanel1);
    ...
    //    event.setId(tfdDescricao.getText());
        ...
        ArrayList<Event> events = eventDAO.listar(event);
        dtm.addColumn("ID");
        dtm.addColumn("NOME");
        
        for (int i = 0; i < events.size(); i++) {
            dtm.addRow(new String[]{String.valueOf(events.get(i).getId()),
    ...
    private void selecionado() {
        ...
        this.event.setId(Integer.parseInt(tblCidades.getValueAt(row, 0).toString()));
        this.event.setName(tblCidades.getValueAt(row, 1).toString());
        dispose();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdgListaEvento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdgListaEvento dialog = new JdgListaEvento(new javax.swing.JFrame(), true);
